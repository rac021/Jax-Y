...
public class Controler       {
        ...
        Runnable r = () -> {
          ...
          try {
               ...
               frame.getTextArea_Result_Custom()
                    .setText(Model.invokeService_Using_Custom( urlService , 
                                                               accept     , 
    ...
    private void setOutputer() {
        PrintStream printStream = new PrintStream(new Outputer(frame.getTextArea_Token() ) ) ;
